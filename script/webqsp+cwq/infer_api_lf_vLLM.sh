...
screen -S api-llm -X stuff "PYTHONPATH=./ CUDA_VISIBLE_DEVICES=0,1 python api/api_llm_lf_server.py --model_name_or_path $model_path --db fb --port 18100 --use_vllm True
"
