...
screen -S api-llm -X stuff "PYTHONPATH=./ CUDA_VISIBLE_DEVICES=0 python tools/api_llm_dialog_server.py --model_name_or_path $model_path --db kqapro --port 18100 --use_vllm True
"
